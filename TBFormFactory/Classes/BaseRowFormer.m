...
+ (BaseRowFormItem *)buildNormalTextLabel:(NSString *)leftName subLabel:(NSString *)subTitle target:(id)sender {
    ...
    UILabel *subLabel = [UILabel labelWithFontSize:14 FontColor:former.subTitleLabelColor frame:CGRectMake(titleLabel.right + former.titleToContentInterval, 0, kScreenWidth - former.titleToContentInterval - 2* former.leftInterval - titleLabel.width, former.height) Text:subTitle];
